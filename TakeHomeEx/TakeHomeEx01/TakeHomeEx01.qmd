...
```{r}
thai_roadlines <- st_read(dsn = "data", layer = "hotosm_tha_roads_lines_shp") %>% st_transform(crs = 32647)
plot(thai_roadlines)
``` 
...
```{r}
# Read from the province layer, contains only
    # Bangkok
    # Nonthaburi
    # Nakhon Pathom
    # Pathum Thani
