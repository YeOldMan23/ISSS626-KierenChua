...
**Question** : From what I see, since the you append the weighted average of the GDP to each region by row, you are essentially spreading out the GDP of each county so that the spread of GDP per county is more even and regions of high GDPPC can be better represented
